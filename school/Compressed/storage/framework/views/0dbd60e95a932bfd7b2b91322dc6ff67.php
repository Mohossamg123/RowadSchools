...
<tr>
    <td align="center" style="padding:40px 24px 24px 24px;">
        <img
            src="https://rowad-backend.pyramedx.com/storage/images/rowad-alnjah-logo.png"
        ...
        <td style="padding:28px 24px 8px 24px;">
            ...
            >
                ...
                <tr>
                    ...
                    >
                        <?php echo e($registration->student_name); ?>
                ...
                <tr>
                    ...
                    <td
                        ...
                        style="padding:14px 16px; font-size:14px; color:#1F1528; text-align:right; direction:rtl; border-bottom:1px solid #E6E2E9;"
                    >
                        <?php echo e($registration->parent_name); ?>
                ...
                <tr>
                    ...
                    >
                        <a
                            href="mailto:<?php echo e($registration->email); ?>"
                ...
                <tr>
                    ...
                    <td
                        ...
                        style="padding:14px 16px; font-size:14px; color:#1F1528; text-align:right; direction:rtl; border-bottom:1px solid #E6E2E9;"
                    >
                        <?php if($registration->gender === 'male'): ?>
                            ذكر
                        <?php elseif($registration->gender === 'female'): ?>
                            أنثى
                        <?php else: ?>
                ...
                <!-- Educational Stage -->
                <?php if($registration->educationalStage): ?>
                    <tr>
                        ...
                        <td
                            ...
                            style="padding:14px 16px; font-size:14px; color:#1F1528; text-align:right; direction:rtl; border-bottom:1px solid #E6E2E9;"
                        >
                            <?php echo e($registration->educationalStage->name); ?>
                ...
                <?php if($registration->grade): ?>
                    <tr>
                        ...
                        >
                            <?php echo e($registration->grade->name); ?>
    ...
    <tr>
        <td align="center" style="padding:24px 24px 36px 24px; direction:rtl;">
            ...
            <div style="margin-top:16px; font-size:11px; color:#9A8CA8;">
                © <?php echo e(date('Y')); ?> Rowad Al Njah Schools
            </div>
...
</html><?php /**PATH /home/u910756261/domains/rowad-backend.pyramedx.com/public_html/school/Compressed/resources/views/emails/student-registration.blade.php ENDPATH**/ ?>