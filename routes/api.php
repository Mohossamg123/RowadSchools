...
|--------------------------------------------------------------------------
*/
use App\Http\Controllers\Api\V1\PublicLinks\LinkClickController;
...
use App\Http\Controllers\Api\V1\TuitionFee\TuitionFeeSettingController;
...
use App\Http\Controllers\Api\V1\AnnouncementBar\AnnouncementBarController;
use App\Http\Controllers\Api\V1\AnnouncementBar\AnnouncementBarSettingController;
...
Route::get('/tuition-fee/setting', [TuitionFeeSettingController::class, 'show']);    Route::put('/tuition-fee/setting', [TuitionFeeSettingController::class, 'update']);
    ...
    */
    ...
    Route::get('/announcement-bars', [
        AnnouncementBarController::class,
        'index',
    ]);

Route::get('/announcement-bar/setting', [AnnouncementBarSettingController::class, 'show']);    Route::put('/announcement-bar/setting', [AnnouncementBarSettingController::class, 'update']);
    Route::get('/announcement-bars/{announcementBar}', [
        AnnouncementBarController::class,
        'show',
    ]);
    ...
    */
    ...
    Route::post('/links/{socialLink}/click', [
    LinkClickController::class,
    'store',
]);
...
Route::post('/site-visits', [
    \App\Http\Controllers\Api\V1\SiteVisit\SiteVisitController::class,
    'store',
]);
